...
@RestController
@RequestMapping("/api/divide-ae-kafka")
public class DivideAeKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DivideAeKafkaResource.class);
    ...
    public DivideAeKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
